...
@allure.epic('Get/api/v1/analytics/payments_analytics/{category_id}/completed_detail - '
             ...
             'проверка поля onetime payment')
class TestAnalyticsCompletedDetailRegularPayment:

    @allure.description('проверка поля onetime payment - Значение True')
    ...
    @allure.description('проверка поля onetime payment - Значение False')
    def test_02(self, create_moneybox_and_delete_for_analytics):
        ...
        try:
            ...
            result_get = AnalyticsMethods.get_payments_analytics_completed_detail_with_params(
                20,
                '?month_from=1&year_from=2020&month_to=1&year_to=2031&regular_payment=true&onetime_payment=false',
                access_token
            )
    ...
    @allure.description('проверка поля onetime payment - Поле отсутствует')
    def test_03(self, create_moneybox_and_delete_for_analytics):
        ...
        try:
            ...
            result_get = AnalyticsMethods.get_payments_analytics_completed_detail_with_params(
                20,
                '?month_from=1&year_from=2020&month_to=1&year_to=2031&regular_payment=true',
                access_token
            )
    ...
    @allure.description('проверка поля onetime payment - Null')
    def test_04(self, create_moneybox_and_delete_for_analytics):
        ...
        try:
            ...
            result_get = AnalyticsMethods.get_payments_analytics_completed_detail_with_params(
                20,
                '?month_from=1&year_from=2020&month_to=1&year_to=2031&regular_payment=true&onetime_payment=null',
                access_token
            )
    ...
    @allure.description('проверка поля onetime payment - Пустое поле')
    def test_05(self, create_moneybox_and_delete_for_analytics):
        ...
        try:
            ...
            result_get = AnalyticsMethods.get_payments_analytics_completed_detail_with_params(
                20,
                '?month_from=1&year_from=2020&month_to=1&year_to=2031&regular_payment=true&onetime_payment=""',
                access_token
            )
    ...
    @allure.description('проверка поля onetime payment - Недопустимое значение')
    def test_06(self, create_moneybox_and_delete_for_analytics):
        ...
        try:
            ...
            result_get = AnalyticsMethods.get_payments_analytics_completed_detail_with_params(
                20,
                '?month_from=1&year_from=2020&month_to=1&year_to=2031&regular_payment=true&onetime_payment=string',
                access_token
            )
