...
@allure.epic('Get/api/v1/analytics/payments_analytics/{category_id}/completed_detail - '
             'Запрос аналитики по исполненным регулярным платежам для заданой категории - проверка поля month from')
class TestAnalyticsCompletedDetailMonthFrom:

    @allure.description('проверка поля month from - Значение  = 1')
    ...
    @allure.description('проверка поля month from - Значение  = 12')
    def test_02(self, create_moneybox_and_delete_for_analytics):
        ...
        try:
            ...
            result_get = AnalyticsMethods.get_payments_analytics_completed_detail_with_params(
                20,
                '?month_from=12&year_from=2025&month_to=12&year_to=2030&regular_payment=true&onetime_payment=true',
                access_token
            )
    ...
    @allure.description('проверка поля month from - Поле отсутствует')
    def test_03(self, create_moneybox_and_delete_for_analytics):
        ...
        try:
            ...
            result_get = AnalyticsMethods.get_payments_analytics_completed_detail_with_params(
                20,
                '?year_from=2025&month_to=12&year_to=2030&regular_payment=true&onetime_payment=true',
                access_token
            )
    ...
    @allure.description('проверка поля month from - Значение  = 0')
    def test_04(self, create_moneybox_and_delete_for_analytics):
        ...
        try:
            ...
            result_get = AnalyticsMethods.get_payments_analytics_completed_detail_with_params(
                20,
                '?month_from=0&year_from=2025&month_to=12&year_to=2030&regular_payment=true&onetime_payment=true',
                access_token
            )
    ...
    @allure.description('проверка поля month from - Значение  = 13')
    def test_05(self, create_moneybox_and_delete_for_analytics):
        ...
        try:
            ...
            result_get = AnalyticsMethods.get_payments_analytics_completed_detail_with_params(
                20,
                '?month_from=13&year_from=2025&month_to=12&year_to=2030&regular_payment=true&onetime_payment=true',
                access_token
            )
    ...
    @allure.description('проверка поля month from - Отрицательное значение')
    def test_06(self, create_moneybox_and_delete_for_analytics):
        ...
        try:
            ...
            result_get = AnalyticsMethods.get_payments_analytics_completed_detail_with_params(
                20,
                '?month_from=-6&year_from=2025&month_to=12&year_to=2030&regular_payment=true&onetime_payment=true',
                access_token
            )
    ...
    @allure.description('проверка поля month from - Вещественное число')
    def test_07(self, create_moneybox_and_delete_for_analytics):
        ...
        try:
            ...
            result_get = AnalyticsMethods.get_payments_analytics_completed_detail_with_params(
                20,
                '?month_from=1.0&year_from=2025&month_to=12&year_to=2030&regular_payment=true&onetime_payment=true',
                access_token
            )
    ...
    @allure.description('проверка поля month from - Пустое поле')
    def test_08(self, create_moneybox_and_delete_for_analytics):
        ...
        try:
            ...
            result_get = AnalyticsMethods.get_payments_analytics_completed_detail_with_params(
                20,
                '?month_from=""&year_from=2025&month_to=12&year_to=2030&regular_payment=true&onetime_payment=true',
                access_token
            )
    ...
    @allure.description('проверка поля month from - Null')
    def test_09(self, create_moneybox_and_delete_for_analytics):
        ...
        try:
            ...
            result_get = AnalyticsMethods.get_payments_analytics_completed_detail_with_params(
                20,
                '?month_from=null&year_from=2025&month_to=12&year_to=2030&regular_payment=true&onetime_payment=true',
                access_token
            )
