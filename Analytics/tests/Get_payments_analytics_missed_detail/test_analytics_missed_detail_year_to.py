...
@allure.epic('Get/api/v1/analytics/payments_analytics/{category_id}/missed_detail - Запрос аналитики по пропущенным'
             'регулярным платежам для заданной категории - проверка поля year_to')
class TestAnalyticsMissedDetailYearTo:

    @allure.description('проверка поля year_to - Значение = 2020')
    ...
    @allure.description('проверка поля year_to - Значение = 2100')
    def test_02(self, create_moneybox_and_delete_for_analytics):
        ...
        try:
            ...
            get_analytics = AnalyticsMethods.get_payment_analytics_missed_detail_with_params(
                20,
                '?month_from=1&year_from=2020&month_to=12&year_to=2100&regular_payment=true&onetime_payment=true',
                access_token
            )
    ...
    @allure.description('проверка поля year_to - year_from > year_to')
    def test_04(self, create_moneybox_and_delete_for_analytics):
        ...
        try:
            ...
            get_analytics = AnalyticsMethods.get_payment_analytics_missed_detail_with_params(
                20,
                '?month_from=1&year_from=2100&month_to=12&year_to=2025&regular_payment=true&onetime_payment=true',
                access_token
            )
    ...
    @allure.description('проверка поля year_to - Значение = 2019')
    def test_05(self, create_moneybox_and_delete_for_analytics):
        ...
        try:
            ...
            get_analytics = AnalyticsMethods.get_payment_analytics_missed_detail_with_params(
                20,
                '?month_from=1&year_from=2020&month_to=12&year_to=2019&regular_payment=true&onetime_payment=true',
                access_token
            )
    ...
    @allure.description('проверка поля year_to - Значение = 2101')
    def test_05(self, create_moneybox_and_delete_for_analytics):
        """Авторизация"""
        moneybox_id, wallet_id, access_token = create_moneybox_and_delete_for_analytics
        ...
        try:
            ...
            get_analytics = AnalyticsMethods.get_payment_analytics_missed_detail_with_params(
                20,
                '?month_from=1&year_from=2020&month_to=12&year_to=2101&regular_payment=true&onetime_payment=true',
                access_token
            )
    ...
    def test_06(self, create_moneybox_and_delete_for_analytics):
        ...
        try:
            ...
            get_analytics = AnalyticsMethods.get_payment_analytics_missed_detail_with_params(
                20,
                '?month_from=1&year_from=2020&month_to=12&year_to=""&regular_payment=true&onetime_payment=true',
                access_token
            )
