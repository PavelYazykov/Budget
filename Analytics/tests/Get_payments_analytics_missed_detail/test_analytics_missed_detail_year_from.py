...
@allure.epic('Get/api/v1/analytics/payments_analytics/{category_id}/missed_detail - Запрос аналитики по пропущенным'
             'регулярным платежам для заданной категории - проверка поля year_from')
class TestAnalyticsMissedDetailYearFrom:

    @allure.description('проверка поля year_from - Значение = 2020')
    def test_01(self, create_moneybox_and_delete_for_analytics):
        ...
        try:
            ...
            get_analytics = AnalyticsMethods.get_payment_analytics_missed_detail_with_params(
                20,
                '?month_from=1&year_from=2020&month_to=12&year_to=2031&regular_payment=true&onetime_payment=true',
                access_token
            )
    ...
    @allure.description('проверка поля year_from - Значение = 2100')
    ...
    def test_03(self, create_moneybox_and_delete_for_analytics):
        ...
        try:
            ...
            get_analytics = AnalyticsMethods.get_payment_analytics_missed_detail_with_params(
                20,
                '?month_to=12&year_to=2031&regular_payment=true&onetime_payment=true',
                access_token
            )
    ...
    @allure.description('проверка поля year_from - Значение = 2019')
    def test_04(self, create_moneybox_and_delete_for_analytics):
        ...
        try:
            ...
            get_analytics = AnalyticsMethods.get_payment_analytics_missed_detail_with_params(
                20,
                '?month_from=1&year_from=0&month_to=12&year_to=2100&regular_payment=true&onetime_payment=true',
                access_token
            )
    ...
    @allure.description('проверка поля year_from - Значение = 2101')
    def test_04(self, create_moneybox_and_delete_for_analytics):
        """Авторизация"""
        moneybox_id, wallet_id, access_token = create_moneybox_and_delete_for_analytics
        ...
        try:
            ...
            get_analytics = AnalyticsMethods.get_payment_analytics_missed_detail_with_params(
                20,
                '?month_from=1&year_from=2101&month_to=12&year_to=2100&regular_payment=true&onetime_payment=true',
                access_token
            )
    ...
    def test_05(self, create_moneybox_and_delete_for_analytics):
        ...
        try:
            ...
            get_analytics = AnalyticsMethods.get_payment_analytics_missed_detail_with_params(
                20,
                '?month_from=1&year_from=""&month_to=12&year_to=2100&regular_payment=true&onetime_payment=true',
                access_token
            )
