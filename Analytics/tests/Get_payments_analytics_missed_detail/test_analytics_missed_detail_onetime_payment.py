...
@allure.epic('Get/api/v1/analytics/payments_analytics/{category_id}/missed_detail - Запрос аналитики по пропущенным'
             'регулярным платежам для заданной категории - проверка поля onetime_payment')
class TestAnalyticsMissedDetailOnetimePayment:

    @allure.description('проверка поля onetime_payment - Значение True')
    ...
    @allure.description('проверка поля onetime_payment - Значение False')
    def test_02(self, create_moneybox_and_delete_for_analytics):
        ...
        try:
            ...
            get_analytics = AnalyticsMethods.get_payment_analytics_missed_detail_with_params(
                20,
                '?month_from=1&year_from=2025&month_to=1&year_to=2031&regular_payment=true&onetime_payment=false',
                access_token
            )
    ...
    def test_03(self, create_moneybox_and_delete_for_analytics):
        ...
        try:
            ...
            get_analytics = AnalyticsMethods.get_payment_analytics_missed_detail_with_params(
                20,
                '?month_from=1&year_from=2025&month_to=1&year_to=2031&regular_payment=true',
                access_token
            )
    ...
    def test_04(self, create_moneybox_and_delete_for_analytics):
        ...
        try:
            ...
            get_analytics = AnalyticsMethods.get_payment_analytics_missed_detail_with_params(
                20,
                '?month_from=1&year_from=2025&month_to=1&year_to=2031&regular_payment=true&onetime_payment=null',
                access_token
            )
    ...
    def test_05(self, create_moneybox_and_delete_for_analytics):
        ...
        try:
            ...
            get_analytics = AnalyticsMethods.get_payment_analytics_missed_detail_with_params(
                20,
                '?month_from=1&year_from=2025&month_to=1&year_to=2031&regular_payment=true&onetime_payment=""',
                access_token
            )
    ...
    @allure.description('проверка поля onetime_payment - Недопустимые значения')
    def test_06(self, create_moneybox_and_delete_for_analytics):
        ...
        try:
            ...
            get_analytics = AnalyticsMethods.get_payment_analytics_missed_detail_with_params(
                20,
                '?month_from=1&year_from=2025&month_to=1&year_to=2031&regular_payment=true&onetime_payment=string',
                access_token
            )
