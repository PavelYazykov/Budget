...
class TestGetPaymentInfoById:
    ...
    @allure.description('Запрос объектов payment_info по id - '
                        'Запросить информацию о платежах с существующим payment_info_id')
    def test_01(self, auth_fixture):
        ...
        try:
            ...
            get_result = PaymentInfoMethods.get_payment_info_by_id(111, access_token)

            """Проверка статус кода"""
            Checking.check_statuscode(get_result, 200)

            """Проверка наличия всех полей"""
            Payloads.check_required_fields(get_result, Payloads.get_payloads_by_id)
    ...
    @allure.description('Запрос объектов payment_info по id - '
                        'Запросить информацию о платежах с несуществующим payment_info_id')
    def test_02(self, auth_fixture):
        """Авторизация"""
        access_token = auth_fixture

        """Запрос информации о платеже"""
        get_result = PaymentInfoMethods.get_payment_info_by_id(1111, access_token)

        """Проверка статус кода"""
        Checking.check_statuscode(get_result, 404)

    @allure.description('Запрос объектов payment_info по id - payment_info_id - недопустимые символы')
    def test_03(self, auth_fixture):
        ...
        try:
            ...
            """Запрос информации о платеже"""
            get_result = PaymentInfoMethods.get_payment_info_by_id('12fg', access_token)
    ...
    @allure.description('Запрос объектов payment_info по id - payment_info_id - пустое поле')
    def test_04(self, auth_fixture):
        ...
        try:
            ...
            """Запрос информации о платеже"""
            get_result = PaymentInfoMethods.get_payment_info_by_id('', access_token)
    ...
    @allure.description('Запрос объектов payment_info по id - payment_info_id - Null')
    def test_05(self, auth_fixture):
        ...
        try:
            ...
            """Запрос информации о платеже"""
            get_result = PaymentInfoMethods.get_payment_info_by_id(None, access_token)
