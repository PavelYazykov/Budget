...
class TestGetPaymentInfoCommon:
    ...
    def test_01(self, auth_fixture):
        ...
        try:
            ...
            get_result = PaymentInfoMethods.get_payment_info(access_token)
    ...
    @allure.description('Запрос объектов payment_info  - Запрос информацию о платежах с параметрами')
    def test_02(self, auth_fixture):
        ...
        try:
            ...
            get_result = PaymentInfoMethods.get_payment_info_with_params(
                f'?month=04&regular_outcome_id={regular_outcome_id}', access_token)
