...
class TestSendReportYearFrom:

    @allure.description('проверка поля year_from - Значение year = 2024')
    def test_01(self, auth_fixture):
        ...
        try:
            ...
            result_get = SendReportsMethods.get_send_report_with_params(
                '?month_from=1&year_from=2024&month_to=12&year_to=2026&type_report=csv', access_token
            )
    ...
    @allure.description('проверка поля year_from - Значение year = 2100')
    def test_02(self, auth_fixture):
        ...
        result_personal_budget = PersonalBudgetMethods.create_personal_budget_without_regular_outcome(
            Variables.transaction_type, Variables.category_id, Variables.subcategory_id, Variables.amount,
            Variables.month, 2100, access_token
        )
        Checking.check_statuscode(result_personal_budget, 201)
        data = Checking.get_data(result_personal_budget)
        personal_budget_id = data['data']['id']
        try:
            """Запрос отчета"""
            result_get = SendReportsMethods.get_send_report_with_params(
                '?month_from=1&year_from=2100&month_to=12&year_to=2100&type_report=csv', access_token
            )
            """Проверка статус кода"""
            Checking.check_statuscode(result_get, 200)
    ...
    def test_03(self, auth_fixture):
        ...
        try:
            """Запрос отчета"""
            result_get = SendReportsMethods.get_send_report_with_params(
                '?month_from=1&month_to=12&year_to=2026&type_report=csv', access_token
            )
            """Проверка статус кода"""
            Checking.check_statuscode(result_get, 200)
    ...
    @allure.description('проверка поля year_from - Значение year = 2023')
    def test_04(self, auth_fixture):
        ...
        try:
            """Запрос отчета"""
            result_get = SendReportsMethods.get_send_report_with_params(
                '?month_from=1&year_from=2023&month_to=12&year_to=2026&type_report=csv', access_token
            )
            """Проверка статус кода"""
    ...
    @allure.description('проверка поля year_from - Значение year = 2101')
    def test_05(self, auth_fixture):
        ...
        try:
            """Запрос отчета"""
            result_get = SendReportsMethods.get_send_report_with_params(
                '?month_from=1&year_from=2101&month_to=12&year_to=2026&type_report=csv', access_token
            )
            """Проверка статус кода"""
            Checking.check_statuscode(result_get, 422)
        except AssertionError as e:
    ...
    def test_07(self, auth_fixture):
        ...
        try:
            """Запрос отчета"""
            result_get = SendReportsMethods.get_send_report_with_params(
                '?month_from=1&year_from=hjhj&month_to=12&year_to=2026&type_report=csv', access_token
            )
            """Проверка статус кода"""
            Checking.check_statuscode(result_get, 422)
        except AssertionError as e:
