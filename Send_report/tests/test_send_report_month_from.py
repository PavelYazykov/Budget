...
class TestSendReportMonthFrom:

    @allure.description('проверка поля month_from - Значение месяца = 1')
    def test_01(self, auth_fixture):
        ...
        try:
            ...
            result_get = SendReportsMethods.get_send_report_with_params(
                '?month_from=1&year_from=2026&month_to=12&year_to=2026&type_report=csv', access_token
            )
    ...
    @allure.description('проверка поля month_from - Значение месяца = 01')
    ...
    @allure.description('проверка поля month_from - Значение месяца = 12')
    def test_03(self, auth_fixture):
        ...
        try:
            """Запрос отчета"""
            result_get = SendReportsMethods.get_send_report_with_params(
                '?month_from=12&year_from=2026&month_to=12&year_to=2026&type_report=csv', access_token
            )
            """Проверка статус кода"""
            Checking.check_statuscode(result_get, 200)
    ...
    def test_04(self, auth_fixture):
        ...
        try:
            """Запрос отчета"""
            result_get = SendReportsMethods.get_send_report_with_params(
                '?year_from=2026&month_to=12&year_to=2026&type_report=csv', access_token
            )
            """Проверка статус кода"""
            Checking.check_statuscode(result_get, 200)
    ...
    @allure.description('проверка поля month_from - Значение месяца = 0')
    def test_05(self, auth_fixture):
        ...
        try:
            """Запрос отчета"""
            result_get = SendReportsMethods.get_send_report_with_params(
                '?month_from=0&year_from=2026&month_to=12&year_to=2026&type_report=csv', access_token
            )
            """Проверка статус кода"""
    ...
    @allure.description('проверка поля month_from - Значение месяца = 13')
    def test_06(self, auth_fixture):
        ...
        try:
            """Запрос отчета"""
            result_get = SendReportsMethods.get_send_report_with_params(
                '?month_from=13&year_from=2026&month_to=12&year_to=2026&type_report=csv', access_token
            )
            """Проверка статус кода"""
            Checking.check_statuscode(result_get, 422)
    ...
    @allure.description('проверка поля month_from - Отрицательное значение')
    def test_07(self, auth_fixture):
        ...
        try:
            """Запрос отчета"""
            result_get = SendReportsMethods.get_send_report_with_params(
                '?month_from=-5&year_from=2026&month_to=12&year_to=2026&type_report=csv', access_token
            )
            """Проверка статус кода"""
            Checking.check_statuscode(result_get, 422)
    ...
    def test_08(self, auth_fixture):
        ...
        try:
            """Запрос отчета"""
            result_get = SendReportsMethods.get_send_report_with_params(
                '?month_from=цу&year_from=2026&month_to=12&year_to=2026&type_report=csv', access_token
            )
            """Проверка статус кода"""
            Checking.check_statuscode(result_get, 422)
